$(document).ready(function () {
  ...
  var myCalendar = createCalendar({
    ...
    data: {
      // Event title
      title: "Tuấn and Phương's Wedding",

      // Event start date
      start: new Date("Feb 25, 2023 16:00"),
      ...
      end: new Date("Feb 25, 2023 18:00"),

      // Event Address
      address: "Nhà trai, thôn Hùng Vĩ, xã Đồng Văn, huyện Yên Lạc, tỉnh Vĩnh Phúc",

      // Event Description
      description:
        "Thân mời bạn đến dự lễ cưới của chúng tớ! Mọi vấn đề xin liên hệ Tuấn: (+84) 363 839 897",
    },
  });
  ...
  $("#rsvp-form").on("submit", function (e) {
    ...
    // } else {
      $.post(
        "https://script.google.com/macros/s/AKfycbwaQ7nbTcyCIvXrRt2oKVmbUkfeAYt1OsrHu9az4hj9fNgYN2GfKeDx2mn8lYFv8Auu/exec",
        data
      )
...
// Google map
function initMap() {
  var location = { lat: 20.8461707, lng: 106.7051749 };
...
function initBBSRMap() {
  var la_fiesta = { lat: 20.8461707, lng: 106.7051749 };
  var map = new google.maps.Map(document.getElementById("map-canvas"), {
    zoom: 15,
    center: la_fiesta,
    scrollwheel: false,
